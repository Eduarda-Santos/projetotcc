@extends('templates.middleware', ['titulo'=>"Alterar Vacinas"])

@section('conteudo')

<form action="{{ route('vacinas.update', $data->id) }}" method="POST">
    @csrf
    @method('PUT')
    <div class="row">
        <div class="col">
    ...
    <div class="row">
        <div class="col">
            <a href="{{route('vacinas.index')}}" class="btn btn-secondary btn-block align-content-center">
